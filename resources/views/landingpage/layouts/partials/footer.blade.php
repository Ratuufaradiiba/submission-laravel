		...
		<div class="row">
			<div class="col-lg-4 col-md-6">
				<div class="widget footer-widget mb-5 mb-lg-0">
					...
					<img src="landingpage/theme/images/about.jpg" alt="" class="img-fluid">
			...
			<div class="col-lg-4 col-md-6">
				<div class="widget footer-widget mb-5 mb-lg-0">
			        ...
			        <div class="media pb-3 sidebar-post-item">
			            <a href="#"><img class="mr-4" src="landingpage/theme/images/news/thumb-1.jpg" alt=""></a>
			        ...
			        <div class="media py-3 sidebar-post-item">
			            <a href="#"><img class="mr-4" src="landingpage/theme/images/news/thumb-2.jpg" alt=""></a>
			           <div class="media-body">
			           		<span class="text-uppercase font-sm font-extra letter-spacing"> Travel</span>
				...
				<div class="widget footer-widget">
					...
					<div class="row no-gutters">
		                <div class="col-lg-4 col-md-6 col-sm-6 col-6">
		                    <a href="#"><img class="img-fluid" src="landingpage/theme/images/f1.jpg" alt=""/></a>
		                </div>
		                <div class="col-lg-4 col-md-6 col-sm-6  col-6">
		                    <a href="#"><img class="img-fluid" src="landingpage/theme/images/f2.jpg" alt=""/></a>
		                </div>
		                <div class="col-lg-4 col-md-6 col-sm-6  col-6">
		                    <a href="#"><img class="img-fluid" src="landingpage/theme/images/f3.jpg" alt=""/></a>
		                </div>
		                <div class="col-lg-4 col-md-6 col-sm-6  col-6">
		                    <a href="#"><img class="img-fluid" src="landingpage/theme/images/f4.jpg" alt=""/></a>
		                </div>
		                <div class="col-lg-4 col-md-6 col-sm-6  col-6">
		                    <a href="#"><img class="img-fluid" src="landingpage/theme/images/f2.jpg" alt=""/></a>
		                </div>
